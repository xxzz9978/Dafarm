		...
		<article>
			<header>
				<div class="side">
					...
					<div class="nav">
						<div class="simple">
							<a href="${path }seller/seller_user/main"> <img src="${path }resources/img/simple.png">
								&nbsp; &nbsp; 요약
							</a>
						</div>

						<div class="order">
							<a href="${path }seller/board/order"> <img src="${path }resources/img/order.png">
								&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 주문
							</a>
						</div>

						<div class="store">
							<a href="${path }seller/board/store"> <img src="${path }resources/img/store.png">
								&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 상점
							</a>
						</div>
						<div class="premium">
							<a href="${path }seller/board/premium"> <img src="${path }resources/img/premium.png">
								&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 프리미엄 관리
							</a>
						</div>
