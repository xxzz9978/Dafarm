		...
		<article>
				...
				<main>
					...
					<div class="product_detail">
						<form:form action="${path }seller/board/addProduct_pro" method="post"
							modelAttribute="addProductBean" enctype="multipart/form-data">
							<form:hidden path="product_writer_num"/>
							<div class="harf1">
							...
							<div class="harf2">
							<label for="product_image" class="product_list_image">첨부 이미지</label>
							<div class="imgDIV"></div>
								...
								<div class="modify_delete1">
									<form:button class="read_modify">등록</form:button>
								</div>
								<div class="modify_delete2">
									<a href="${path }seller/board/store"
