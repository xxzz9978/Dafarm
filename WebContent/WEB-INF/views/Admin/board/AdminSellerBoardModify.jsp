...
<html lang="ko">
    <head>
        ...
        <title>다팜 | 판매자 공지사항 글 수정/삭제</title>
        <!-- JQuery -->
		...
		<script src="${path}/resources/Admin_Resources/js/seller_board_modify.js"></script>
    </head>
 <!-- body -->
		...
		<div id="layoutSidenav_content">
                <main>
		           <div class="container-fluid px-4">
		               <h1 class="mt-4">판매자 공지사항 글 수정/삭제</h1>
		               <ol class="breadcrumb mb-4">
		                   ...
		                   <li class="breadcrumb-item active">판매자 공지사항 글 수정/삭제</li>
		               </ol>
		               <form:form action="${path }/Admin/board/AdminSellerBoardModify_pro" method="post" 
		               modelAttribute="adminSellerBoardBean">
		                   ...
		                   <div class="text-end">
		                       ...
		                       <button onclick="return board_delete(event, ${adminSellerBoardBean.seller_board_num})" 
