...
<html lang="ko">
    <head>
		...
		<script src="${path}/resources/Admin_Resources/js/user_board_write.js"></script>
    </head>
 <!-- body -->
		...
		<div id="layoutSidenav_content">
                <main>
		           <div class="container-fluid px-4">
		               <h1 class="mt-4">구매자 공지사항 글 작성</h1>
		               <ol class="breadcrumb mb-4">
		                   ...
		                   <li class="breadcrumb-item active">구매자 공지사항 글 작성</li>
		               </ol>
		               <form:form action="${path }/Admin/board/AdminUserBoardWrite_pro" method="post" modelAttribute="adminUserBoardBean" enctype="multipart/form-data">
