...
<script src="${path}/resources/Admin_Resources/js/buyer_delete.js"></script>
</head>
<!-- body -->
								...
								<tbody>
									...
									<tr>
										...
										<td class="align-middle text-center"><input type="text"
											...
											value="${adminUserBean.user_num }" readonly></td>
										<th class="align-middle text-center border-start border-end">가입일자</th>
										<td class="align-middle text-center border-end"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_access_date }" readonly>
										</td>
									</tr>
									<tr>
										...
										<td class="align-middle text-center"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_name }" readonly></td>
										<th class="align-middle text-center border-start border-end">전화번호</th>
										<td class="align-middle text-center border-end"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_phone }" readonly></td>
									</tr>
									<tr>
										<th class="align-middle text-center border-start border-end">이메일</th>
										<td class="align-middle text-center"><input type="email"
											class="form-control border-0"
											value="${adminUserBean.user_email }" readonly></td>
										<th class="align-middle text-center border-start border-end">주소</th>
										<td class="align-middle text-center border-end"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_address }" readonly></td>
									</tr>
									<tr>
										<th class="align-middle text-center border-start border-end">아이디</th>
										<td class="align-middle text-center"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_id }" readonly></td>
										<th class="align-middle text-center border-start border-end">비밀번호</th>
										<td class="align-middle text-center border-end"><input type="text"
											class="form-control border-0"
											value="${adminUserBean.user_password }" readonly></td>
									</tr>
										<tr>
										<th class="align-middle text-center border-start border-end">구매횟수</th>
										<td class="align-middle text-center"><input type="text"
											class="form-control border-0"
											value="${adminProfitBean.orderCount } 건" readonly></td>
										<th class="align-middle text-center border-start border-end">사용금액 합계</th>
										<td class="align-middle text-center border-end"><input type="text"
											class="form-control border-0"
							...
							<div class="row text-center">
								<div class="col-sm-8 offset-sm-2">
									<button class="btn btn-primary"
										...
										onclick="return buyer_delete(event, ${adminUserBean.user_num})">삭제</button>
									<button class="btn btn-primary"
										style="background-color: #008748; border-color: black; color: white;"
										onclick="location.href='${path}/Admin/table/AdminBuyerModify?user_num=${adminUserBean.user_num}'">수정</button>
