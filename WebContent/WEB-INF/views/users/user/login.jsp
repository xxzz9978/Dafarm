...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${path}resources/user_style/user_login.css" />
		...
		<div class="intro_bg">
			...
			<div class="login_area">
				...
				<div class="switch_login_form">
					...
					<!-- User 로그인 form -->
					<form:form action="${path}users/user/login_pro_user" method="post" modelAttribute="tempLoginUserBean" class="user_login_form">
						<div id="login_form">
						<div class="id">
							<form:label path="user_id">아이디</form:label>
							<form:input path="user_id" placeholder="일반회원 로그인 ID"/>
							<form:errors path="user_id" style="color:red"/>
						</div>
						<div class="password">
							<form:label path="user_password">비밀번호</form:label>
							<form:password path="user_password" placeholder="일반회원 로그인 PW" />
						...
						<ul class="user_account">
							<li><a href="${path}users/user/join">회원가입</a></li>
						</ul>
					</form:form>
				</div>
			</div>
